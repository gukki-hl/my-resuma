...
const ScrollBackground = () => {
  ...
  return (
    <div className="absolute inset-0 -z-10">
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-linear-to-r from-primary/5 via-blue-500/5 to-purple-500/5 rounded-full blur-3xl opacity-30 md:opacity-60" />
      <motion.div
